...
# =====================================================
# FACTURA PDF CON PRESENTACIÓN - INNOVA FOOD
# =====================================================
@login_required
@user_passes_test(es_admin)
def descargar_factura(request, pedido_id):
    ...
    data = [
        ["Producto", "Presentación", "Cantidad", "Precio unitario", "Subtotal"]
    ]
    ...
    tabla = Table(
        data,
        colWidths=[2.0 * inch, 1.2 * inch, 0.9 * inch, 1.2 * inch, 1.1 * inch]
    )
    ...
    nota = """
    <b>Nota:</b> Documento generado automáticamente por el sistema Innova Food.
    El precio se calcula por presentación registrada del producto.
    """
